...
import com.example.capstone.utils.createCustomTempFile
import java.io.File
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                override fun onImageSaved(output: ImageCapture.OutputFileResults) {
                    cropImageToSquare(photoFile) { croppedFile ->
                        val intent = Intent()
                        intent.putExtra(EXTRA_CAMERAX_IMAGE, croppedFile.absolutePath)
